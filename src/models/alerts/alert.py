...
class Alert(object):
    ...
    def __repr__(self):
        return "<Alert for {} for item {} on price {}>".format(self.user_email,self.item.name,self.price_limit)
    ...
    def find_needing_update(cls,minutes_since_update=AlertConstants.ALERT_TIMEOUT):
        ...
        return [cls(**elem) for elem in Database.find(AlertConstants.COLLECTION,{'last_checked':{"$lte":last_updated_limit},'active':True})]
    ...
    def send_email_if_price_is_reached(self):
